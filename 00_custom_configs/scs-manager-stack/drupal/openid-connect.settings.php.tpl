...
// Redirect to dbms/_oauth/logout to clear forward-auth cookie, then Keycloak redirects to manager.
$config['openid_connect.settings']['redirect_logout'] = 'https://dbms.${SCS_SUBDOMAIN}.${SCS_BASE_DOMAIN}/_oauth/logout';
