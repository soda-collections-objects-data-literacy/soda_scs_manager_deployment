 ...
 * @endcode
 */
$settings['hash_salt'] = 'wYHwA7t8lc9XIeorbtGUsuLrisdKTGvi3FBt-1jc-uyNMXTZPUa3K1eSNmeq7Yu7G2dsVh36Yg';
...
$databases['default']['default'] = array (
  'database' => 'scs-manager',
  'username' => 'scs-manager',
  'password' => 'bQq8KP88cMibVzRctCm8',
  'prefix' => '',
  'host' => 'database',
  'port' => 3306,
...
$settings['config_sync_directory'] = 'sites/default/files/config_uSOimy2M2TtZHpgN5Jo0auIZplawQpR9TeXcW3LZI3UHE4T_Et3jnuSNbD3VGbDVH6BYUOjdXA/sync';
$settings['system.logging']['error_level'] = 'verbose';
$settings['file_private_path'] = '/var/scs-manager/';
$settings['content_sync_directory'] = 'modules/custom/soda_scs_manager/content';
$settings['trusted_host_patterns'] = [
  '^scs\.sammlungen\.io',
];
