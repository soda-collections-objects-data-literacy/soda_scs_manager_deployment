...
### Method 1: Manual Creation with Specific Subnets (Exact Match)

This recreates the network with the exact current configuration:
...
**Note:** The IPv6 subnet `fd5e:e17b:ef02:1::/64` is randomly generated by Docker. Your installation will have a different IPv6 subnet.

### Method 2: Manual Creation with Auto Subnets (Recommended for Manual)
...
This is simpler and allows Docker to manage subnet allocation.

### Method 3: Docker Compose Creation (BEST PRACTICE)
...
2. **IPv6 Subnet**: `fd5e:e17b:ef02:1::/64` (huge address space)
   - Gateway: `fd5e:e17b:ef02:1::1`
